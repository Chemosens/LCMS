ibm_save=function(repository,rt,class,integrationTable2,listFiles=NULL,ppmThreshold=15,comparisonToPeaks=TRUE,centroided=FALSE,ppm=10,limitIntegration=0.1,name=NULL,repo="",byCTP=0.001,higherThanNoise=10,minimalIntensityForPeak=50,msLevel=1,minimalNumberOfPoints=0)
{
